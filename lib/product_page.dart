...
class SingleItem extends StatefulWidget {
  ...
  const SingleItem({super.key, required this.product});
    ...
    return showDialog<void>(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: Text("You've bought 5 ${widget.product.productName}!"),
          actions: [
            TextButton(
              child: const Text('OK'),
              onPressed: () {
      ...
      child: Row(
        ...
        children: [
          ...
          Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text("Counts: ${widget.product.qyt}"),
              ElevatedButton(
                onPressed: () {
                  setState(() {
                    widget.product.qyt++;
